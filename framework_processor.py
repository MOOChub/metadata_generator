...
class Framework_processor:
    ...
    @staticmethod
    def remove_fileending(file_name):
    ...
    def find_framework_files():
        ...
        return list(map(Framework_processor.remove_fileending, files))
    ...
    def find_fields(input_params):
        ...
        if framework_type == "ESCO":
            return Framework_processor.find_skill_fields(path, config_framework, level, value)
        elif framework_type == "FoS":
            return Framework_processor.find_fos_fields(path, config_framework, level, value)
...
class Data_storage:
    ...
    def delete_value(self, framework, value, forgoing_value):
...
class Entry:
    ...
    def generate_names_of(self, value):
        all_names = []
